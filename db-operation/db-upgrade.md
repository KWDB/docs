...
| 部署拓扑 | 当前版本 | 目标版本 | 升级方式 |
|---------|---------|---------|---------|
| 单机部署 | 3.0.0、3.1.0 | 3.2.0 | 脚本和命令行部署：安装程序<br>容器镜像部署：容器镜像升级 |
|  | 1.x、2.x | 3.2.0 | 导入导出 |
| 多副本集群 | 3.0.0、3.1.0 | 3.2.0 | 脚本和命令行部署：安装程序<br>容器镜像部署：容器镜像升级 |
|  | 1.x、2.x | 3.2.0 | 导入导出 |
| 单副本集群 | 3.0.0、3.1.0 | 3.2.0 | 脚本和命令行部署：安装程序<br>容器镜像部署：容器镜像升级 |
|  | 1.x、2.x | 3.2.0 | 导入导出 |
