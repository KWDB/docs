...
- **在线升级**：通过逐一升级集群节点将 2.2.x 至 2.2.2 版本。在升级过程中，升级节点上的压缩与生命周期可能会执行失败，在升级完成后恢复正常。如果升级过程中出现错误，例如节点未安装 KWDB、节点状态异常或部署方式有误，系统将中止升级，并给予相应提示。
...
以下步骤适用于单副本集群 2.2.x 至 2.2.2 版本的升级：
