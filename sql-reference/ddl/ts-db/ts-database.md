...
- 生命周期和分区时间范围设置与系统的存储空间密切相关。生命周期越长，分区时间范围越大，系统所需的存储空间也越大。有关存储空间的计算公式，参见[硬件](../../../db-operation/cluster-planning.md#硬件)。
...
![](../../../static/sql-reference/ZE2Pbz9DvoUUBkxFPKZcCBo6nqd.png)
