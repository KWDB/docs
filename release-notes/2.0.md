...
- 支持通过 [MyBatis](../development/connect-kaiwudb/java/connect-mybatis.md)、[MyBatis-Plus](../development/connect-kaiwudb/java/connect-mybatis-plus.md) 等主流框架协议连接数据库并读写数据。
