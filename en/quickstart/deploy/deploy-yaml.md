...
- Obtained KWDB [container image](../prepare.md#container-images).
...
1. Create the `docker-compose.yml` configuration file.
    ...
    ::: warning Note
    The `image` parameter must match the image name obtained after importing the `KaiwuDB.tar` file.
    :::
