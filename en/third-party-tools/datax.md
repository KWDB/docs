...
| `jdbcUrl`   | The JDBC connection URL for the KWDB database. For more information, see [JDBC Connection Parameters](../development/java/connect-jdbc.md#connection-parameters). |
