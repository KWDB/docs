...
- Allows database connection and data read/write operations via industry-standard frameworks such as [MyBatis](../development/java/connect-mybatis.md) and [MyBatis-Plus](../development/java/connect-mybatis-plus.md).