...
## Contextual Min/Max Queries

The contextual min/max queries feature in KWDB allows you to retrieve the complete row context when using `min` or `max` functions. This feature extends beyond standard SQL syntax limitations, enabling you to obtain complete contextual information about extreme values in a single query.
