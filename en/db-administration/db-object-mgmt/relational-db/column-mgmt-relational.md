...
| `column_name` | The name of the column to add. The column name must be unique within the table and must follow these [Identifier Rules](../../../../en/sql-reference/sql-identifiers.md). |
