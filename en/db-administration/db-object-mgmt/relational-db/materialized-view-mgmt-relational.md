...
| `view_name` | The name of the materialized view to create. The materialized view name must be unique within the database and must follow these [Identifier Rules](../../../../en/sql-reference/sql-identifiers.md). When the parent database is not set as the default, the name must be formatted as `database.view_name`. |
...
| `name` | The new name of the materialized view. The materialized view name must be unique within the database and must follow these [Identifier Rules](../../../../en/sql-reference/sql-identifiers.md). |
