...
| `index_name` | The name of the index to create. The index name must be unique within the database and must follow these [Identifier Rules](../../../../en/sql-reference/sql-identifiers.md). |
...
| `new_name` | The new name of the index. The index name must be unique within the database and must follow these [Identifier Rules](../../../../en/sql-reference/sql-identifiers.md).|
