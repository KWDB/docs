...
- Modify zones for other databases or ranges/tables in other databases: the user must be a member of the `admin` role or have been granted `CREATE` or `ZONECONFIG` privileges on the specified object(s).
