...
The definition of each column in `column_list` is as follows:
...
- Create a time-series table and specify encoding and compression for each column.
...
- `partition_by_clause`: Create table partitions. For details, see [Partitions](./partition-mgmt-ts.md).
- RENAME
...
- Change the table name and data retention.
...
| Parameter    | Description                                                                                                                                                        |
|--------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `db_name` | The name of the database from which to remove tables. If not specified, use the current database. |
| `table_name` | The name of the table. You can use `<database_name>.<table_name>` to specify a table in another database. If not specified, use the table in the current database. |
