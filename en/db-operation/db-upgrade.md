...
|--------------------|----------------|----------------|----------------|
| Standalone deployment | 3.0.0,  3.1.0, 3.2.0 | 3.2.2 | Script or CLI deployment: installer<br>Container image deployment: container image upgrade |
|                      |  2.x | 3.2.2 | Import/export |
| Multi-replica cluster | 3.0.0, 3.1.0, 3.2.0 | 3.2.2 | Script or CLI deployment: installer<br>Container image deployment: container image upgrade |
|                      |  2.x | 3.2.2 | Import/export |
| Single-replica cluster | 3.0.0, 3.1.0, 3.2.0 | 3.2.2 | Script or CLI deployment: installer<br>Container image deployment: container image upgrade |
|                       |  2.x | 3.2.2 | Import/export |
